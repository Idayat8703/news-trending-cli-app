class NewsTrending::Scraper
  ...
  def self.scrape_nytimes2
    doc = Nokogiri::HTML(open("http://www.nytimes.com/pages/politics/index.html?action=click&pgtype=Homepage&region=TopBar&module=HPMiniNav&contentCollection=Politics&WT.nav=page"))
    article = NewsTrending::Article.new
